...
export default function Auth() {
	...
	return (
		<div
			...
			className="min-h-screen bg-#f9fafb relative overflow-hidden flex items-center justify-center p-4"
		>
			{/* Animated Background */}
			...
			<div className="relative z-10 w-full max-w-4xl">
                ...
                <Brain className="w-12 h-12 text-white" />
							...
							<h1 className="text-5xl font-bold text-zinc mb-4">Vigilant</h1>
						...
						<div className="bg-white backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl mt-8 mb-4">
							...
							<div className="text-center mb-8">
								<h2 className="text-3xl font-bold text-zinc mb-2">
									{isLogin ? "Welcome Back!" : "Join Vigilant"}
								</h2>
